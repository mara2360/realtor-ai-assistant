...
export default function MethodPage() { return <AtlasPage eyebrow="The Block Atlas method" title="Research without the rush." intro="A repeatable way to separate durable signals from urgency, tribal narratives, and price-driven certainty." features={[
