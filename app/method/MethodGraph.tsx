    ...
    <section className="method-graph" aria-labelledby="method-graph-title">
      <div className="shell">
        ...
        <div className="method-graph-grid">
          ...
          <div className="graph-panel" role="img" aria-label={`Research signal graph. Overall score ${score} percent. ${reading}.`}>
            <div className="graph-scale" aria-hidden="true"><span>100</span><span>75</span><span>50</span><span>25</span><span>0</span></div>
